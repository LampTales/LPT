...
accelerator = Accelerator(split_batches=True) # batch_size 始终由用户控制，不随GPU数量变化
...
if __name__ == "__main__":
    ...
    task = Task.init(project_name='Long-tailed Prompt Tuning', task_name='Tune VPT on CIFAR-LT')
